...
public class CustomExceptionTests
{
    ...
    public void CustomException_WithMessage_SetsCorrectExceptionMessage()
    {
        ...
        var innerException = new InvalidOperationException(expectedMessage);
    ...
    public void CustomExceptionHelper_New_CreatesExceptionWithCorrectMessage()
    {
        ...
        // Assert
        Assert.That(exception.Message, Is.EqualTo("A custom exception happened")); // Default exception message
